...
pub fn execute(input: &[String]) -> (i32, i32) {
    ...
    (part1(&points, box_bounds), part2(&points, box_bounds))
}

pub fn part1(points: &[(i32, i32)], bounds: (i32, i32, i32, i32)) -> i32 {
    ...
    map.iter()
        ...
        .map(|(_k, v)| v.num_points)
        .unwrap()
}

pub fn part2(points: &[(i32, i32)], bounds: (i32, i32, i32, i32)) -> i32 {
    let (tl_x, tl_y, br_x, br_y) = bounds;
...
fn get_nearest_point(pts: &[(i32, i32)], test_pt: (i32, i32)) -> ((i32, i32), bool) {
    let mut unique = true;
