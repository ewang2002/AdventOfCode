...
fn main() {
    ...
    if args.is_empty() {
        println!("Usage: ./aoc2021 <day> [test]");
    ...
    match day_to_use {
        ...
        20 => run::<crate::aoc::Day20>(test_case),
        21 => run::<crate::aoc::Day21>(test_case),
        22 => run::<crate::aoc::Day22>(test_case),
        24 => run::<crate::aoc::Day24>(test_case),
        25 => run::<crate::aoc::Day25>(test_case),
        _ => {
